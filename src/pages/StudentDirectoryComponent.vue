    ...
    <q-page-container>
      ...
      <q-page class="body">
        ...
        <div align="center" style="margin: 10px;">
          <input type="search" class="search-bar" placeholder="Enter Name, Course or Year and Section">
          <q-btn type="button" label="Find"
            style="  padding: 6px 12px; height: 46px; background: #1a73e8; border: 1px solid rgb(60, 63, 68); border-radius: 20px; color: rgb(247, 248, 248); appearance: none; transition: border 0.15s ease 0s; width: 100px; align-items: center; margin-left: 20px; font-family: 'Product Sans Medium', sans-serif" />
        </div>
        <div class="table-responsive">
          <table class="table table-bordered table-striped" style="color: white">
            ...
            <tr v-for="user in users" :key="user.id_num">
        ...
        <q-dialog v-model="viewDetailsModal">
          <q-card class="custom-card" style="width: 600vw;">
            <q-card-section>
            ...
            <q-card-section>
              <div class="text-h6">
                <p>Name: {{ selectedStudent.lname }}, {{ selectedStudent.fname }} {{ selectedStudent.mname }}</p>
            ...
            <div class="footer" style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
              <q-btn type="button" @click="closeViewDetailsModal"
                style="margin-right: 10px; border-radius: 20px;   padding: 6px 12px; background: rgb(31, 32, 35); border: 1px solid rgb(60, 63, 68); color: rgb(247, 248, 248); appearance: none; transition: border 0.15s ease 0s; width: 150px; align-items: center; font-family: 'Product Sans medium', sans-serif;">Back to List</q-btn>
            </div>
          </q-card>
        </q-dialog>
      </q-page>
