            ...
            <q-header elevated class="header">
                <q-toolbar>
                    ...
                    <div class="row" style="margin-left: 700px;">
                        ...
                        <q-btn type="button" class="btn btn-danger" @click="logout"
                            style="width: 155px; border-radius: 30px;"> <svg xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <div class="nav-bar" style="margin-left: 70px;">
                        <q-tabs>
                            <li class="nav-item list-unstyled" style="margin-right: 50px;">
                                <router-link to="/HomeComponent" class="nav-link text-white"
                                    @click="setActiveTab('HomeComponent')"
                            ...
                            <li class="nav-item list-unstyled" style="margin-right: 50px;">
                                <router-link to="/SchedulesComponent" class="nav-link text-white"
                                    @click="setActiveTab('SchedulesComponent')"
                                    :class="{ active: activeTab === 'SchedulesComponent' }"><i class="mx-2"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li class="nav-item list-unstyled" style="margin-right: 50px;">
                                <router-link to="/ContactsComponent" class="nav-link text-white"
                                    @click="setActiveTab('ContactsComponent')"
                                    :class="{ active: activeTab === 'ContactsComponent' }"><i class="mx-1"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li class="nav-item list-unstyled" v-if="userType === 'admin'" style="margin-right: 50px;">
                                <router-link to="/ComposeComponent" class="nav-link text-white"
                                    @click="setActiveTab('ComposeComponent')"
                            ...
                            <li class="nav-item list-unstyled" v-if="userType === 'user'">
                                <router-link to="/ViewProfile" class="nav-link text-white"
                                    @click="setActiveTab('ViewProfile')" :class="{ active: activeTab === 'ViewProfile' }"><i
                                        class="mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
